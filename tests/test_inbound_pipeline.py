...
from mcp_shield.core.models import JSONRPCRequest, SecurityContext, SecurityVerdict
...
def test_windows_dos_device_name_blocked(engine):
    ...
    for dev in devices:
        ctx = SecurityContext(session_id="s_dev", user_id="dev_agent", role="developer")
