...
from mcp_shield.core.hitl import ApprovalStatus
...
class StdioProxy:
    ...
    async def run(self) -> int:
        self.console.print(f"[bold green]🛡️ MCP-Shield active.[/bold green] Wrapping: [cyan]{' '.join(self.command)}[/cyan]")
            ...
            while True:
                ...
                if result.verdict == SecurityVerdict.BLOCK:
                    ...
                    error_resp = {
                        ...
                        "error": {
                            "code": -32000,
                            "message": f"Blocked by MCP-Shield Security Firewall: {result.blocked_reason}",
            ...
            while True:
                ...
                if matching_req and matching_req.method in ("tools/list", "list_tools"):
                    ...
                    if not is_valid:
                        ...
                        error_resp = {
                            ...
                            "error": {
                                "code": -32003,
                                "message": f"Blocked by MCP-Shield: Tool Poisoning detected: {schema_violations[0].reason}",
                ...
                if result.verdict == SecurityVerdict.REDACTED and result.modified_payload:
                    ...
                    error_resp = {
                        ...
                        "error": {
                            "code": -32002,
                            "message": "Blocked by MCP-Shield: Outbound tool output contained dangerous prompt injection payload.",
                        },
                    }
                    self._write_client_stdout(error_resp)
                else:
